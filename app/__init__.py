...
restaurant_routes.register_blueprint(review_routes, url_prefix='/<int:restaurant_id>/reviews')
restaurant_routes.register_blueprint(reservation_routes, url_prefix='/<int:restaurant_id>')
